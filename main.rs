...
fn main() {
    ...
    let mut socket = mio::net::UdpSocket::bind("127.0.0.1:3000".parse().unwrap()).unwrap();
    poll.registry()
    ...
    config
        .load_cert_chain_from_pem_file("/home/camille/Documents/rust/server_quiche/cert.pem")
        .unwrap();
    config
        .load_priv_key_from_pem_file("/home/camille/Documents/rust/server_quiche/key.pem")
        .unwrap();
    config
                ...
                loop {
                    ...
                    match http3_conn.poll(&mut client.conn) {
                        Ok((stream_id, quiche::h3::Event::Headers { list, .. })) => {
                            handle_request(client, stream_id, &list, "examples/root");
                        }
